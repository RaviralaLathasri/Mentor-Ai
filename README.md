...
GitHub License Python FastAPI React
...
Redis - For session management (redis.io)
Docker - For containerized deployment (docker.com)
...
Enter name, skills, interests, goals
Set confidence level
System adapts based on profile
2. Mentor Chat
Go to Chat page
Ask questions or describe concepts
Receive Socratic mentoring responses
Rate response quality (helpful/too_easy/too_hard/unclear)
Analytics track improvement
3. Audio Interview
Navigate to Interview section
Click "Start Interview"
Speak and system transcribes in real-time
...
PROFILE_DATA_USAGE.md - Data privacy
🤝 Contributing
...
GitHub: @RaviralaLathasri
Project: Mentor AI
🙏 Acknowledgments
Built with FastAPI and React
LLM powered by OpenAI and OpenRouter
...
Confirm .env has a valid LLM key/base.
Restart backend after .env changes.
Watch backend logs while asking a question.
...
See DEPLOYMENT_READY_GUIDE.md for production deployment steps.
